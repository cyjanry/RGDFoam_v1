    ...
    Hf_(readScalar(is))
{
    ...
    cpTable.outOfBounds(extrapolation2DTable<scalar>::ERROR);
    hTable.outOfBounds(extrapolation2DTable<scalar>::ERROR);
/*
...
{
    Hf_ *= this->W();
    Info << " HF_ is: " << Hf_/this->W() << endl; // to out put the Hf_ value
    cpTable = extrapolation2DTable<scalar>("constant/cpTable");
    hTable = extrapolation2DTable<scalar>("constant/hTable");
    cpTable.outOfBounds(extrapolation2DTable<scalar>::ERROR);
    hTable.outOfBounds(extrapolation2DTable<scalar>::ERROR);
